    ...
    const fetchInstallationData = async () => {
        try {
            ...
            const [profileResponse, assignmentsResponse] =
                await Promise.all([
                    fetch(`${API_BASE}/api/installation/me`, {
                        headers,
                    }),
                    fetch(
                        `${API_BASE}/api/installation/assigned-installations`,
                        {
                            headers,
                        }
                    ),
            ...
            if (!profileResponse.ok) {
                throw new Error(
                    profileData.message ||
                        "Failed to fetch installation profile"
                );
            }
            ...
            if (!assignmentsResponse.ok) {
                throw new Error(
                    assignmentsData.message ||
                        "Failed to fetch assigned installations"
                );
            }
        ...
        <div style={styles.page}>
            <div style={styles.header}>
                ...
                <p style={styles.subtitle}>
                    Manage your installation profile and
